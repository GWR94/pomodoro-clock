...
const Arrows: React.FC<ArrowsProps> = ({
  ...
  return (
    <div className="arrows__container">
      <p className="arrows__time-container">
        Minutes {work ? "to work" : "on break"}
      </p>
      <div
        ...
        onClick={(): void => {
          work
            ? onHandleArrowClick(true, false)
            : onHandleArrowClick(false, false);
        }}
      >
        <img
          src={arrowLeft}
      ...
      <div
        ...
        onClick={(): void => {
          work
            ? onHandleArrowClick(true, true)
            : onHandleArrowClick(false, true);
        }}
      >
        <img
          src={arrowRight}
